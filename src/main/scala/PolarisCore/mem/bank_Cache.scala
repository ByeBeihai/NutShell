...
sealed abstract class MBCacheBundle(implicit cacheConfig: MBCacheConfig) extends Bundle with HasPolarisCoreParameter with MBHasCacheConst
sealed abstract class MBCacheModule(implicit cacheConfig: MBCacheConfig) extends Module with HasPolarisCoreParameter with MBHasCacheConst with HasPolarisCoreLog
...
class MBCacheIO(implicit val cacheConfig: MBCacheConfig) extends Bundle with HasPolarisCoreParameter with MBHasCacheConst {
