...
sealed abstract class CacheModule(implicit cacheConfig: CacheConfig) extends Module with HasPolarisCoreParameter with HasCacheConst with HasPolarisCoreLog
