...
class SIMD_Pipelsu_Bundle extends PolarisCoreBundle with HasPolarisCoreParameter with HasLSUConst{
...
class pipeline_lsu_stage1 extends PolarisCoreModule with HasLSUConst with HasPolarisCoreParameter{
