...
class FrontendIO(implicit val p: PolarisCoreConfig) extends Bundle with HasPolarisCoreConst {
...
trait HasFrontendIO {
  implicit val p: PolarisCoreConfig
  val io = IO(new FrontendIO)
}

class Frontend_ooo(implicit val p: PolarisCoreConfig) extends PolarisCoreModule with HasFrontendIO {
...
class Frontend_embedded(implicit val p: PolarisCoreConfig) extends PolarisCoreModule with HasFrontendIO {
...
class Frontend_inorder(implicit val p: PolarisCoreConfig) extends PolarisCoreModule with HasFrontendIO {
...
class Frontend_SIMD(implicit val p: PolarisCoreConfig) extends PolarisCoreModule with HasFrontendIO {
